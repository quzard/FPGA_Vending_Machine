...
HD_PWD='C:/Users/11918/OneDrive/FPGA/project_3/project_3.runs/pic_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pic.tcl
